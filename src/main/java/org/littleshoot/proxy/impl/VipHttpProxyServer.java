...
public class VipHttpProxyServer implements HttpProxyServer {
    ...
    protected void setChainProxyManager(ChainedProxyManager chainedProxyManager) {
    ...
    private static class DefaultHttpProxyServerBootstrap implements HttpProxyServerBootstrap {
        ...
        @Override
        public HttpProxyServerBootstrap withProStr(String proStr) {
            this.proStr = proStr;
            return this;
        }
        ...
        private VipHttpProxyServer build() {
            ...
            return new VipHttpProxyServer(serverGroup,
                    ...
                    allowRequestToOriginServer,proStr);
        }
